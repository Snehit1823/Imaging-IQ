...
import { supabase } from "@/lib/supabase";   // Connect to your database
...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { data, error } = await supabase.auth.signUp({
      ...
      options: {
        data: {
          full_name: fullName, // Save their name in the user metadata
        },
      },
    });
    ...
    <main className="min-h-screen bg-[#0F172A] relative flex items-center justify-center p-4 overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Join ImagingIQ for precise diagnostics</p>
        </div>
        ...
        >
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-xs text-slate-500 uppercase">Or register with</span>
            <div className="h-[1px] bg-slate-700 flex-1" />
          </div>
